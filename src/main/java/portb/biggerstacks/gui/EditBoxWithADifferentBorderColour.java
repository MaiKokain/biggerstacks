...
@OnlyIn(Dist.CLIENT)
public class EditBoxWithADifferentBorderColour extends Widget implements IRenderable, IGuiEventListener
{
    ...
    public EditBoxWithADifferentBorderColour(FontRenderer pFont, int pX, int pY, int pWidth, int pHeight, @Nullable net.minecraft.client.gui.widget.TextFieldWidget p_i232259_6_, ITextComponent pMessage)
    {
