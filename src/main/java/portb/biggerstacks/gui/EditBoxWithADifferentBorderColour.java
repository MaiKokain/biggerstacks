...
//I wanted a different border colour -_-
@OnlyIn(Dist.CLIENT)
public class EditBoxWithADifferentBorderColour extends AbstractWidget implements Widget, GuiEventListener
{
    ...
    private static final int                                                BORDER_COLOR            = 0xff_c7c7c7;
    ...
    public EditBoxWithADifferentBorderColour(Font pFont, int pX, int pY, int pWidth, int pHeight, @Nullable net.minecraft.client.gui.components.EditBox p_94111_, Component pMessage)
    {
    ...
    public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick)
    {
        if (this.isVisible())
        {
            if (this.isBordered())
            {
                int i = this.isFocused() ? -1 : BORDER_COLOR;
    ...
    public void updateNarration(NarrationElementOutput pNarrationElementOutput)
    {
        pNarrationElementOutput.add(NarratedElementType.TITLE,
                                    Component.translatable("narration.edit_box", this.getValue())
        );
    }
}